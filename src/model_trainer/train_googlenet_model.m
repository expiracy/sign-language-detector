...
outputDir = fullfile(pwd, 'outputs', sprintf('googlenet_%s', datestr(now, 'yyyy-mm-dd_HH-MM-SS')));
...
try
    net = googlenet;
    fprintf('GoogLeNet loaded.\n');
catch
    error('GoogLeNet not found. Please install the support package.');
end
