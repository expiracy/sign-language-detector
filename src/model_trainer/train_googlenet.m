...
%% SECTION 4: Load and Modify GoogLeNet
fprintf('\n[Step 4] Configuring GoogLeNet...\n');
...
outputFolder = fullfile(pwd, '..', 'outputs', [timestamp '_googlenet']);

if ~exist(outputFolder, 'dir')
    mkdir(outputFolder);
end

networkPath = fullfile(outputFolder, 'ASL_GoogLeNet_Trained.mat');
